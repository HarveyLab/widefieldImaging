...
settings.nRepeats = 35; % How often each direction is repeated, i.e. there will be 4 times as many sweeps. Garrett uses 6-10 times 10, so up to 100 sweeps!
...
if strcmp(getComputerName,'shin-pc')
    load('C:\Users\Shin\Documents\GitHub\widefieldImaging\intrinsicScope_gammaTable_160725.mat')
else
